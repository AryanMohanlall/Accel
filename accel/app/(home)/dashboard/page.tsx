      ...
      <Row gutter={[15, 0]}>
        <Col span={6}>
          <div className={styles.summaryTile}>
            <Statistic
              title="Active Deals"
              value={data.opportunities.activeCount}
            />
          </div>
        </Col>
        <Col span={6}>
          <div className={styles.summaryTile}>
            <Statistic
              ...
              value={data.contracts.totalActiveCount}
            />
          </div>
        </Col>
        <Col span={6}>
          <div className={styles.summaryTile}>
            <Statistic
              title="Weekly Tasks"
              value={data.activities.completedThisWeekCount}
            />
          </div>
        </Col>
        <Col span={6}>
          <div className={styles.summaryTileHighlight}>
            <Statistic
              title="Win Rate"
              value={data.opportunities.winRate}
              suffix="%"
            />
          </div>
        </Col>
          ...
          {visibleStages.map((s) => (
            <Col span={6} key={s.stage}>
              <div className={styles.statBox}>
                <Statistic
                  title={
                    <Text className={styles.statBoxLabel}>{s.stageName}</Text>
                  }
                  value={s.count}
                  styles={{
                    content: {
          ...
          {revenueItems.map((item) => (
            <Col span={6} key={item.label}>
              ...
              >
                <Statistic
                  title={
                    <span className={styles.revenueLabel}>{item.label}:</span>
                  }
                  value={item.value}
                  prefix="$"
                  styles={{
