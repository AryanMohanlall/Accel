                  ...
                  {msg.role === "assistant" ? (
                    <ReactMarkdown
                      components={{
                        ...
                        strong:     ({ children }) => <strong style={{ color: "#00b86e" }}>{children}</strong>,
                        code:       ({ children }) => (
                          <code style={{ background: "#0a0a0a", border: "1px solid #222", borderRadius: "4px", padding: "1px 5px", fontSize: "0.75rem", fontFamily: "monospace", color: "#00b86e" }}>
                            {children}
                          </code>
                        ),
                        pre: ({ children }) => (
                          <pre style={{ background: "#0a0a0a", border: "1px solid #1e1e1e", borderRadius: "8px", padding: "10px 12px", overflowX: "auto", fontSize: "0.75rem", margin: "6px 0" }}>
                            {children}
                          </pre>
                        ),
                        h1:         ({ children }) => <h1 style={{ fontSize: "1rem",   color: "#f0f0f0", margin: "6px 0 4px" }}>{children}</h1>,
                        h2:         ({ children }) => <h2 style={{ fontSize: "0.9rem", color: "#e0e0e0", margin: "6px 0 4px" }}>{children}</h2>,
                        h3:         ({ children }) => <h3 style={{ fontSize: "0.85rem",color: "#d0d0d0", margin: "4px 0"   }}>{children}</h3>,
                        blockquote: ({ children }) => (
                          <blockquote style={{ borderLeft: "3px solid #00b86e", paddingLeft: "10px", margin: "4px 0", color: "#888", fontStyle: "italic" }}>
                            {children}
                          </blockquote>
                        ),
                        a: ({ href, children }) => (
                          <a href={href} style={{ color: "#00b86e", textDecoration: "underline" }} target="_blank" rel="noreferrer">
                            {children}
                          </a>
                        ),
                        hr: () => <hr style={{ border: "none", borderTop: "1px solid #1e1e1e", margin: "8px 0" }} />,
                      }}
                    >
                      {msg.content}
                    </ReactMarkdown>
